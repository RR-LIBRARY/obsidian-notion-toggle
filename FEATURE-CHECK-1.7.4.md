# Feature check — Notion Toggle v1.7.4

Date: 2026-09-25. Suite: **1110 tests, 0 fail**, typecheck green, release build green (`main.js` = `dist/main.js`).
...
1. BRAT → update to **1.7.4**, restart Obsidian.
